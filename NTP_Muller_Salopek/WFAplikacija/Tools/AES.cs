...
{
    /// <summary>
    /// EXAMPLE: encryptedstring = AES.Encrypt(username, "AGARAMUDHALA", "EZHUTHELLAM", 3, "@1B2c3D4e5F6g7H8", 256);
    /// </summary>
    class AES
    {
        public static string Encrypt(string passtext, string passPhrase, string saltV, int Iterations, string initVect, int keysize)
        {
            ...
            password = new PasswordDeriveBytes(passPhrase, saltValueBytes, "SHA1", Iterations);
        ...
        public static string Decrypt(string cipherText, string passPhrase, string saltValue, int passwordIterations, string initVector, int keySize)
        {
            ...
            // several iterations.
            PasswordDeriveBytes password = default(PasswordDeriveBytes);
            password = new PasswordDeriveBytes(passPhrase, saltValueBytes, "SHA1", passwordIterations);
